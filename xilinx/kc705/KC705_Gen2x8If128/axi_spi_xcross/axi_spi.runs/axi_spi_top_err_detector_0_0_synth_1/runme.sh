...
HD_PWD='D:/Vivado2018_wrk/axi_spi_xcross/axi_spi.runs/axi_spi_top_err_detector_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_spi_top_err_detector_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_spi_top_err_detector_0_0.tcl
