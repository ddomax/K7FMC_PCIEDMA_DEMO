...
HD_PWD='D:/K7_FMC_PCIE/K7FMC_PCIEDMA_DEMO/xilinx/kc705/KC705_Gen2x8If128/axi_spi_xcross/axi_spi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log jesd_adc_part.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source jesd_adc_part.tcl -notrace
