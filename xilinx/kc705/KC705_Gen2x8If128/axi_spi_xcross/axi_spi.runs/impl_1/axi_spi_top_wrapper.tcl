...
set rc [catch {
  ...
  add_files -quiet D:/K7_FMC_PCIE/K7FMC_PCIEDMA_DEMO/xilinx/kc705/KC705_Gen2x8If128/axi_spi_xcross/axi_spi.runs/synth_1/axi_spi_top_wrapper.dcp
...
set rc [catch {
  ...
  write_bitstream -force axi_spi_top_wrapper.bit -bin_file
