...
HD_PWD='D:/K7_FMC_PCIE/K7FMC_PCIEDMA_DEMO/xilinx/kc705/KC705_Gen2x8If128/axi_spi_xcross/axi_spi.runs/PCIEBridge_axis_data_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PCIEBridge_axis_data_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PCIEBridge_axis_data_fifo_0_0.tcl
