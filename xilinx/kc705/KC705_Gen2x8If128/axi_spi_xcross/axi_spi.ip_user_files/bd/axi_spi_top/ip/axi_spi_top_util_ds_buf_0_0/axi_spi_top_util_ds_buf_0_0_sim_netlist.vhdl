...
--               d:/Vivado2018_wrk/axi_spi/axi_spi.srcs/sources_1/bd/axi_spi_top/ip/axi_spi_top_util_ds_buf_0_0/axi_spi_top_util_ds_buf_0_0_sim_netlist.vhdl
...
entity axi_spi_top_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUF_TYPE of axi_spi_top_util_ds_buf_0_0_util_ds_buf : entity is "OBUFDS";
  attribute C_SIZE : integer;
  attribute C_SIZE of axi_spi_top_util_ds_buf_0_0_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of axi_spi_top_util_ds_buf_0_0_util_ds_buf : entity is "util_ds_buf";
end axi_spi_top_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of axi_spi_top_util_ds_buf_0_0_util_ds_buf is
...
entity axi_spi_top_util_ds_buf_0_0 is
  ...
  attribute NotValidForBitStream of axi_spi_top_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of axi_spi_top_util_ds_buf_0_0 : entity is "axi_spi_top_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of axi_spi_top_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of axi_spi_top_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2018.1";
end axi_spi_top_util_ds_buf_0_0;

architecture STRUCTURE of axi_spi_top_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of OBUF_DS_N : signal is "XIL_INTERFACENAME OBUF_DS_N, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN axi_spi_top_util_ds_buf_0_0_OBUF_DS_N";
  attribute x_interface_info of OBUF_DS_P : signal is "xilinx.com:signal:clock:1.0 OBUF_DS_P CLK";
  attribute x_interface_parameter of OBUF_DS_P : signal is "XIL_INTERFACENAME OBUF_DS_P, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN axi_spi_top_util_ds_buf_0_0_OBUF_DS_P";
...
begin
U0: entity work.axi_spi_top_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_I(0) => '0',
